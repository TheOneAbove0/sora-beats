...
const PlayerControl = ({
    ...
    const currentTime = useAppStore(state => state.currentMusicTime)
    const setCurrentTime = useAppStore(state => state.setCurrentMusicTime)
    const isPlaying = useAppStore(state => state.isPlaying)
    const setIsPlaying = useAppStore(state => state.setPlayingState)
    const volume = useAppStore(state => state.volume)
    const setVolume = useAppStore(state => state.setVolume)
    const changeMusic = useAppStore(state => state.changeMusic)
    const repeatType = useAppStore(state => state.repeatType)
    const setRepeat = useAppStore(state => state.setRepeatType)
    const disableKeydown = useAppStore(state => state.disableKeyDown)
